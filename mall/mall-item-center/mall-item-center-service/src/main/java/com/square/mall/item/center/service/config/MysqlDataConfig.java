package com.square.mall.item.center.service.config;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.square.mall.item.center.service.dao", sqlSessionFactoryRef = "itemSessionFactory")
public class MysqlDataConfig {
    ...
    public SqlSessionFactory sessionFactory() throws Exception {
        ...
        sessionFactory.setTypeAliasesPackage("com.square.mall.item.center.service.eo");
