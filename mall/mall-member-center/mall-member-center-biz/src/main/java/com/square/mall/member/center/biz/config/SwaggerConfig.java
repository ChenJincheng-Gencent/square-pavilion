...
public class SwaggerConfig {
    ...
    @Bean(value = "memberCenter")
    @Order(value = 16)
    public Docket groupRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(groupApiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.square.mall.member.center.biz"))
    ...
    private ApiInfo groupApiInfo(){
        return new ApiInfoBuilder()
                .title("四方阁会员中心")
                .description("本项目用于提供会员相关业务的中心层功能")
                .termsOfServiceUrl("192.168.31.12:8200")
